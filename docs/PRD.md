...
6. 用户可上传 MP3/WAV/OGG 音乐，并在对话中指定为 BGM；未上传音乐时可选择内置轻快合成配乐。点击视频预览或成片卡片，进入「剪辑拼接」详情页查看片段与音轨；如需裁剪、分割、排序或配音，仍通过对话发送要求。
...
| 分镜与背景音乐 | 上传视频显示自动切镜时间点和代表帧；对话可引用镜头并确定拼接顺序。上传音频或内置配乐在导出 MP4 中形成真实音轨，可预览与下载。 |
